...
public class Main {
    public static void main(String[] Args) {
        ...
        int[] arrays1 = new int[]{0, 40, 41, 42, 43, 44, 25, 32, 33, 34, 90, 94, 100};
        int[] arrays2 = new int[]{0, 40, 41, 42, 43, 44, 25, 32, 33, 34, 90, 94, 100};

        DecimalFormat df2 = new DecimalFormat("#.##");
        Note note = new Note();
        note.setNote(arrays1);
